...
public abstract class BaseDao<T> {
    ...
    public DataProperties getProperties(){
        ...
        dataProperties.setCols(getCols());
    ...
    public void update(T t){
        DataUtil dataUtil=new DataUtil(getProperties());
        DataProperties update = dataUtil.update();
        JdbcUtil<T> jdbcUtil=new JdbcUtil<>(update);
        jdbcUtil.update(t);
    }
    ...
    public void insert(T t){
        DataUtil dataUtil=new DataUtil(getProperties());
        DataProperties insert=dataUtil.insert();
        JdbcUtil<T> jdbcUtil=new JdbcUtil<>(insert);
        jdbcUtil.insert(t);
    }
